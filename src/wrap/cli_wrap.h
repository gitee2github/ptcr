 ...
 * Author: xiapin
 * Create: 2021-11-29
 * Description: provide client wrapper class definition.
 ******************************************************************************/
#ifndef SRC_WRAP_CLI_WRAP_H
#define SRC_WRAP_CLI_WRAP_H

#include "wrap.h"

class cliWrapperCls : public measureWrapperCls {
public:
    explicit cliWrapperCls(string &cliName) : m_cliName(cliName)
    {
    }
    virtual ~cliWrapperCls() {}
